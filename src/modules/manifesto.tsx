...
export default async function Manifesto() {
  const { leftLine1, leftLine2, rightLine1, rightLine2, image } =
    await getManifestoContent();

  return (
    <section
      id="manifesto"
      className="grid md:grid-cols-8 grid-cols-1 order-2 md:order-1 pt-10 md:pt-0 px-2 pb-48 items-end gap-y-20 md:gap-0"
    >
